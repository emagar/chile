...
Return to puzzle.
Scholars have noted the paradox. Both \citet{berrios.gamboa.fiscChile.2006} and \citet{aleman.navia.UrgChi.2009} suggest that the value of the urgency authority lies in its signaling capacity.  
...
Alemán Navia and lawyers explain disconnect between (a) frequent use despite (b) no penalty for non-compliance by Congress as signaling presidential priority. Both interviewed Cardona. 
...
Hypothesis 1: $Pr(\text{urgent consideration}) >>  Pr(\text{standard consideration})$. Auxiliary assumptions: all three preference profiles occur equiprobably; status quo density has [0,1] support.
