...
This paper has argued that the effects of urgency authority are procedural. We portray Latin American constitutional urgency authority as equivalent to the fast-track authority that United States presidents enjoy periodically: proposals that presidents qualify as urgent are considered under restrictive rules by the chamber's plenary. Amendments and other motions are forbidden, the proposal must be voted up or down. While all constitutions remain silent about prodecural implications of urgencies, and we have verified that our characterization matches Chilean sub-constitutional institutions only, it is plausible and likely that others do too. After all, the rationale of the urgency authority is expediting the legislative process, and restrictive rules are a natural choice to speed urgent bills' consideration before an explicit deadline expires. 
