...
\begin{abstract}
\noindent Among Latin American president's formidable proactive legislative powers is fast-track authority, also called urgency authority. Seven presidents have the power to impose lawmakers a short deadline to discuss and vote bills in this track. While in most cases the absence of congressional action brings about some type of punishment for legislators, Chile stands out in that such punishment does not exist. Extant research has shown that most executive proposals become urgent at some stage, and that urgency correlates with the odds of passage, but it found little evidence that it speeds consideration of the president's agenda in Congress. This paper shows that the main reason behind the use of fast-track authority in Chile is not to speed legislation along, but instead to give presidents the ability to shield bills coming from "friendly" committees from any type of floor amendments. Thus, instead of being a mechanism to speed up the process, presidents' fast-track authority is similar to imposing a "closed rule" on the floor. The paper tests hypotheses derived from a formal model of restrictive rules with data from the 1998--2014 period.
\end{abstract}
...
This paper builds on the existing literature, but makes a different point. We claim that counter what one might expect, fast-track authority in Chile is neither a signal nor an agenda setting tool, but instead a mechanism that protects the bills sponsored by the president from changes in the floor. When the president labels a bill as urgent, such bill cannot be amended on the floor. In this way, the fast track authority works as a close rule by locking in the bill as it came out from committee.
...
Theoretically, we find that when the preferences of the committee chair and the President are close (on one side of the floor median), the president has strong incentives to fast track bills coming from such committee.  On the contrary, we find that standard consideration of bills happens only when president and committee are on either side of the floor median. By analyzing a dataset that includes all the bills initiated by the president from 1998 until 2014, we find that the probability that a bills is marked as urgent increases when the chair of the committee that has jurisdiction over the bill is close to the president's preferences.   
