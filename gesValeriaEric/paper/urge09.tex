...
\begin{table}%[!htbp]
  ...
  \begin{tabular}{@{\extracolsep{0pt}}lD{.}{.}{-3} D{.}{.}{-3} D{.}{.}{-3} D{.}{.}{-3} } 
    ...
    \\ [-1.8ex] 
    \hline \\[-1.8ex] 
    \emph{Co-partisan}     &  .193^{**} &  &  &                                        \\
    \emph{comm.~chair}     & (.046)    &  &  &                                         \\ [.75ex]
    \emph{Coalition}       &  &  .403^{**} &  .429^{**} &  .414^{**}                   \\
    \emph{comm.~chair}     &  & (.031)    & (.023)    & (.027)                         \\ [.75ex]
    \emph{Multiple}        &  .801^{***} &  .829^{***} &  .845^{***} &  .842^{***}     \\
    \emph{referrals}       & (<.001)    & (<.001)    & (<.001)    & (<.001)            \\ [.75ex] 
    \emph{Hacienda}        & 1.787^{***} & 1.762^{***} & 1.743^{***} & 1.746^{***}     \\
    \emph{referral}        & (<.001)   & (<.001)   & (<.001)   & (<.001)               \\ [.75ex]
    \emph{Member bill}     & -2.906^{***} & -2.935^{***} & -3.040^{***} & -3.022^{***}  \\ 
                           & (<.001)   & (<.001)   & (<.001)   & (<.001)               \\ [.75ex]
    \emph{Pres.}           &  -.002 &  -.016 &  .011 &  -.010                          \\
    \emph{approval}        & (.968)    & (.778)    & (.860)    & (.865)                \\ [.75ex]
    \emph{Introduced}      &  .303^{***} &  .322^{***} &  .313^{***} &  .318^{***}     \\
    \emph{in Senate}       & (.006)    & (.004)    & (.005)    & (.004)                \\ [.75ex]
    \emph{Senate}          &  -.118 &  -.152 &  &                                      \\
    \emph{majority}        & (.488)    & (.371)    &  &                                \\ [.75ex]
    \emph{Year}            &  .094^{**} &  .091^{**} &  .083^{*} &  .084^{*}           \\
    \emph{remaining}       & (.039)    & (.046)    & (.066)    & (.063)                \\ [.75ex]
    \emph{Relax}           &  .360^{*} &  .318 &  &                                    \\
    \emph{deadlines}       & (.076)    & (.111)    &  &                                \\ [.75ex]
    %% \emph{2002-06 Leg.} &  &  &  -.054 &                                            \\
    %%                     &  &  & (.749)    &                                         \\ [.75ex]
    %% \emph{2006-10 Leg.} &  &  &  .380^{**} &                                        \\
    %%                     &  &  & (.014)    &                                         \\ [.75ex]
    %% \emph{2010-14 Leg.} &  &  &  .713^{***} &                                       \\
    %%                     &  &  & (<.001)   &                                         \\ [.75ex]
    Intercept              &  -.864^{***} & -1.117^{***} & -1.435^{***} & -1.159^{***}\\
                           & (<.001)   & (<.001)   & (<.001)   & (<.001)             \\ [.75ex]
    \hline \\[-1.8ex] 
    ...
    Log$L$ & \multicolumn{1}{c}{-1,718} & \multicolumn{1}{c}{-1,718} & \multicolumn{1}{c}{-1,709} & \multicolumn{1}{c}{-1,716} \\ 
