...
Finally, our investigation adds to the growing literature on restrictive plenary consideration rules. One difference sets fast track mechanisms apart from standard closed rules. The unique role and function to determine whether or not a major bill will be considered, and which amendments and motions will be allowed, is firmly in control of the legislative leadership, acting as sole gatekeepers to the plenary \citep{cox.2006}. As with France's \emph{vote bloqué}, with fast track authority the executive branch gets to pull some of the gatekeeping levers, earning a priceless legislative prerrogative worthy of further research. 
