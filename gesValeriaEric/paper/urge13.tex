...
Fast track authority in the U.S.\ highlights this important consequence of the rule that has been overlooked by the comparative politics literature: when urgent bills come to the floor, \emph{they cannot be modified}. Latin American constitutions remain silent about this. But in Chile, a case we analize below, the standing rules of Congress mandate a closed rule as fast track does in the U.S. \citep{sotoCongChile2015}.\footnote{See the Cámara's standing rules (\emph{Reglamento}), especially arts.\ 118--189.} 
...
LO DE HOWEL MOE NO QUEDABA BIEN EN SECCION 3, DISTRAIA. LO MOVI AQUI. LEER HOWELL Y MOE A LA LUZ DE NUESTROS HALLAZGOS PARA MOSTRAR POR QUE LE DEBE IMPORTAR NUESTRO PAPER A UN AMERICANISTA.
