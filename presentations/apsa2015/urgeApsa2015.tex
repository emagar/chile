...
\title[Agenda obstruction]{Congress skips one turn, again}
...
\item Chile: like Uruguay, but silent on consequences of inaction
...
\item Chamber receiving the message must ``discuss and vote'' before 30 days
